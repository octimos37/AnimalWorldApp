...
public class Tettigoniidae {
    ...
    public Tettigoniidae() {
    }

    public Tettigoniidae(String id, String textData, String image_path, String description, String AnimalVideo, String iFact, String info) {
        this.id = id;
