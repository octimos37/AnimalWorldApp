...
public class Carcharhiniformes {
    ...
    public Carcharhiniformes(String familyID, String familyNameE, String familyNameTV, String imagesFamyli, String descriptionFamily, String ordoID) {
        FamilyID = familyID;
