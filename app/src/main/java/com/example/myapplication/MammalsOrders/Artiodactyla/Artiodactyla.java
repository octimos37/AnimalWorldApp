...
public class Artiodactyla {
    ...
    public Artiodactyla(String familyID, String familyNameE, String familyNameTV, String imagesFamyli, String descriptionFamily, String ordoID) {
        FamilyID = familyID;
