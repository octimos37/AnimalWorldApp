...
public class Insectivora {
    ...
    public Insectivora(String familyID, String familyNameE, String familyNameTV, String imagesFamyli, String descriptionFamily, String ordoID) {
        FamilyID = familyID;
