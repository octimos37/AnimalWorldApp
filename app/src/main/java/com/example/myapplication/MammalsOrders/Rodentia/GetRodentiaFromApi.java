...
public class GetRodentiaFromApi extends AsyncTask<Void, Void, List<Rodentia>> {
    private RodentiaCallback callback;

    public GetRodentiaFromApi(RodentiaCallback callback) {
        this.callback = callback;
    }

    @Override
    protected List<Rodentia> doInBackground(Void... voids) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    Rodentia entity = new Rodentia(id, textData, nameTV, image_path, class_id, ordo_id);
                    result.add(entity);
                }
            }
    ...
    @Override
    protected void onPostExecute(List<Rodentia> myDataEntities) {
