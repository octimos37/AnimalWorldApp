...
public class Ornithorhynchidae {
    private String id;
    ...
    public Ornithorhynchidae() {
    }

    public Ornithorhynchidae(String id, String textData, String image_path, String description, String AnimalVideo, String iFact, String info) {
        this.id = id;
