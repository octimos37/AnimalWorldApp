...
public class Alligatoridae {
    ...
    public Alligatoridae() {
    }

    public Alligatoridae(String id, String textData, String image_path, String description, String AnimalVideo, String iFact, String info) {
        this.id = id;
